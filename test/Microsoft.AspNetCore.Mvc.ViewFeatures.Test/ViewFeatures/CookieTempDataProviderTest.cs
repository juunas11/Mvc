...
namespace Microsoft.AspNetCore.Mvc.ViewFeatures
{
    public class CookieTempDataProviderTest
    {
        ...
        [InlineData(true)]
        [InlineData(false)]
        public void SaveTempData_SetsSecureAttributeOnCookie_OnlyIfRequestIsSecure(bool expectedSecureAttributeValue)
        {
            // Arrange
            var values = new Dictionary<string, object>();
            values.Add("int", 10);
            ...
            httpContext
                ...
                .Returns(expectedSecureAttributeValue);
            httpContext
                .Setup(hc => hc.Response.Cookies)
                .Returns(responseCookies);
            ...
            Assert.Equal(expectedSecureAttributeValue, cookieInfo.Options.Secure);
